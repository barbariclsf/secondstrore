...
import com.squirrel.util.WordFilter;
...
public class GoodsController {
    ...
    public ModelAndView homeGoods(HttpServletRequest request, HttpSession Session) throws Exception {
...
//            return "/goods/homeGoods";
    ...
    public String publishGoodsSubmit(HttpServletRequest request,Image ima,Goods goods,MultipartFile image)
        ...
        User cur_user = (User)request.getSession().getAttribute("cur_user");
        String str = WordFilter.doFilter(goods.getDescrible());
        goods.setDescrible(str);
        goods.setUserId(cur_user.getId());
    ...
    public Map<String,Object> uploadFile(HttpSession session, MultipartFile myfile) throws IllegalStateException, IOException{
        ...
        //存储图片的物理路径  file:F:/springboot-squirrel/images/data/springboot-squirrel/upload/images/
        //String file_path = session.getServletContext().getRealPath("upload");
        String file_path = GgeeConst.UPLOAD_FILE_IMAGE_PATH;
//        String file_path = "F:/springboot-squirrel/images/data/springboot-squirrel/upload/images/";
        System.out.println("111  "+file_path);
        ...
        if(myfile!=null && oldFileName!=null && oldFileName.length()>0){
            ...
            File newFile = new File(file_path+newFileName);
            System.out.println("sd  "+file_path+newFileName);
            //将内存中的数据写入磁盘
